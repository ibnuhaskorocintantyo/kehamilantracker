...
export default function JournalTimeline() {
  ...
  const { data: user, isLoading: isUserLoading } = useQuery<{id: number, pregnancyWeek: number | null}>({
    queryKey: ['/api/users/1'],
  });
  
  const { data: entries, isLoading: isEntriesLoading } = useQuery<JournalEntry[]>({
